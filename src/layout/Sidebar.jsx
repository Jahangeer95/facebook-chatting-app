...
export function Sidebar({isSidebarOpen}) {
  ...
  return (
    <div className={`w-60 border-r border-gray-300 shadow-sm overflow-hidden bg-blue-900 h-screen flex flex-col fixed inset-y-0 left-0 transform transition-transform duration-300 ease-in-out z-50 md:translate-x-0 md:relative md:flex-shrink-0 ${isSidebarOpen? "translate-x-0":"-translate-x-full"}`}>
