...
export function PagePosts() {
  ...
  return (
    <div
      className="max-w-2xl mx-auto p-4 border overflow-auto h-[600px]"
      id="scrollposts"
    >
      <InfiniteScroll
        ...
        {posts.map((post) => (
          ...
          >
            <div className="flex justify-between items-center mb-3">
              ...
              <div className="relative" ref={open === post.id ? menuRef : null}>
                <button
                ...
                {open === post.id && (
                  <div
                    className={`absolute right-0 bg-white border shadow rounded p-2 z-10 ${
